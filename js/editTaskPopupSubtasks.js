...
/**
 * Fügt eine neue Unteraufgabe zu einer Aufgabe hinzu und aktualisiert die Anzeige.
 *
 * @async
 * @returns {Promise<void>}
 */
...
/**
 * Holt den Text der neuen Unteraufgabe aus dem Eingabefeld.
 *
 * @returns {string} Der getrimmte Text der Unteraufgabe.
 */
...
/**
 * Holt die Task-ID und Firebase-ID aus dem Bearbeitungs-Popup.
 *
 * @returns {Object} Ein Objekt mit taskId und firebaseId.
 */
function getTaskIds() {
...
/**
 * Generiert eine eindeutige ID für eine Unteraufgabe.
 *
 * @returns {string} Eine eindeutige Unteraufgaben-ID.
 */
...
/**
 * Fügt eine neue Unteraufgabe zum Aufgabenobjekt hinzu.
 *
 * @param {Object} task - Das Aufgabenobjekt.
 * @param {string} newSubtaskId - Die ID der neuen Unteraufgabe.
 * @param {string} subtaskText - Der Text der neuen Unteraufgabe.
 */
...
/**
 * Aktualisiert die Liste der Unteraufgaben im DOM.
 *
 * @param {string} subtaskText - Der Text der neuen Unteraufgabe.
 * @param {string} newSubtaskId - Die ID der neuen Unteraufgabe.
 * @param {Object} task - Das Aufgabenobjekt.
...
/**
 * Leert das Eingabefeld für neue Unteraufgaben und aktualisiert die Sichtbarkeit von Edit/Delete-Icons.
 */
...
/**
 * Erstellt ein DOM-Element für eine Unteraufgabe im Bearbeitungsmodus.
 *
 * @param {string} subtaskText - Der Text der Unteraufgabe.
 * @param {string} subtaskId - Die ID der Unteraufgabe.
 * @param {Object} task - Das Aufgabenobjekt.
 * @returns {HTMLElement} Das erstellte Listen-Element für die Unteraufgabe.
 */
...
/**
 * Toggles die Sichtbarkeit der Edit/Delete-Icons basierend auf dem Inhalt des Unteraufgaben-Eingabefelds.
 */
...
/**
 * Handhabt das Drücken der Enter-Taste in Eingabefeldern und führt eine Callback-Funktion aus.
 *
 * @param {KeyboardEvent} event - Das Tastatur-Event.
 * @param {Function} callback - Die Callback-Funktion, die ausgeführt werden soll.
 */
